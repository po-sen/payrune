...
func TestPaymentAddressStatusFinderFindByIDRejectsInvalidPersistedChain(t *testing.T) {
	db, mock, err := sqlmock.New()
	if err != nil {
		t.Fatalf("sqlmock.New: %v", err)
	}
	...
	_, _, err = finder.FindByID(context.Background(), newFindPaymentAddressStatusInput(101))
	if !errors.Is(err, outport.ErrPaymentAddressStatusPersistedChainInvalid) {
		t.Fatalf("unexpected invalid chain error: %v", err)
	}
}

func TestPaymentAddressStatusFinderFindByIDRejectsInvalidPersistedNetwork(t *testing.T) {
	db, mock, err := sqlmock.New()
	if err != nil {
		t.Fatalf("sqlmock.New: %v", err)
	}
	...
	_, _, err = finder.FindByID(context.Background(), newFindPaymentAddressStatusInput(101))
	if !errors.Is(err, outport.ErrPaymentAddressStatusPersistedNetworkInvalid) {
		t.Fatalf("unexpected invalid network error: %v", err)
	}
}

func TestPaymentAddressStatusFinderFindByIDRejectsInvalidPersistedAddressPolicyID(t *testing.T) {
	db, mock, err := sqlmock.New()
	if err != nil {
		t.Fatalf("sqlmock.New: %v", err)
	}
	...
	_, _, err = finder.FindByID(context.Background(), newFindPaymentAddressStatusInput(101))
	if !errors.Is(err, outport.ErrPaymentAddressStatusPersistedAddressPolicyIDInvalid) {
		t.Fatalf("unexpected invalid address policy id error: %v", err)
	}
}

func TestPaymentAddressStatusFinderFindByIDRejectsInvalidPersistedReceiptStatus(t *testing.T) {
	db, mock, err := sqlmock.New()
	if err != nil {
		t.Fatalf("sqlmock.New: %v", err)
	}
	...
	_, _, err = finder.FindByID(context.Background(), newFindPaymentAddressStatusInput(101))
	if !errors.Is(err, outport.ErrPaymentAddressStatusPersistedReceiptStatusInvalid) {
		t.Fatalf("unexpected invalid receipt status error: %v", err)
	}
}
