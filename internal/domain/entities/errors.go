...
var (
	...
	ErrPollingErrorReasonRequired        = errors.New("polling error reason is required")
	ErrExpiredReasonRequired             = errors.New("expired reason is required")
	ErrAddressPolicyMismatch             = errors.New("address policy mismatch")
	ErrAddressReferenceRequired          = errors.New("address reference is required")
