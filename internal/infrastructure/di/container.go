	...
	addressPolicyReader := policyadapter.NewAddressPolicyReader([]policyadapter.AddressPolicyConfig{
		{
			...
			MinorUnit:              "satoshi",
			Decimals:               8,
			AddressSourceRef:       os.Getenv("BITCOIN_MAINNET_LEGACY_XPUB"),
		...
		},
		{
			...
			MinorUnit:              "satoshi",
			Decimals:               8,
			AddressSourceRef:       os.Getenv("BITCOIN_MAINNET_SEGWIT_XPUB"),
		...
		},
		{
			...
			MinorUnit:              "satoshi",
			Decimals:               8,
			AddressSourceRef:       os.Getenv("BITCOIN_MAINNET_NATIVE_SEGWIT_XPUB"),
		...
		},
		{
			...
			MinorUnit:              "satoshi",
			Decimals:               8,
			AddressSourceRef:       os.Getenv("BITCOIN_MAINNET_TAPROOT_XPUB"),
		...
		},
		{
			...
			MinorUnit:              "satoshi",
			Decimals:               8,
			AddressSourceRef:       os.Getenv("BITCOIN_TESTNET4_LEGACY_XPUB"),
		...
		},
		{
			...
			MinorUnit:              "satoshi",
			Decimals:               8,
			AddressSourceRef:       os.Getenv("BITCOIN_TESTNET4_SEGWIT_XPUB"),
		...
		},
		{
			...
			MinorUnit:              "satoshi",
			Decimals:               8,
			AddressSourceRef:       os.Getenv("BITCOIN_TESTNET4_NATIVE_SEGWIT_XPUB"),
		...
		},
		{
			...
			MinorUnit:              "satoshi",
			Decimals:               8,
			AddressSourceRef:       os.Getenv("BITCOIN_TESTNET4_TAPROOT_XPUB"),
